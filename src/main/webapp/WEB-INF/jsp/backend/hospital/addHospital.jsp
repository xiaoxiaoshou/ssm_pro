    ...
    <form class="layui-form" id="adddHospital">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="hospitalName" name="hospitalName" required="" lay-verify="hospitalName"
            ...
            <div class="layui-input-inline">
                <input type="text" id="hospitalPhone" name="hospitalPhone" required="" lay-verify="hospitalPhone"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-input-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" id="hospitalDeanName" name="hospitalDeanName" required="" lay-verify="hospitalDeanName"
                       autocomplete="off" class="layui-input">
            </div>
            ...
            <div class="layui-input-inline">
                <input type="text" id="hospitalYear" name="hospitalYear" required="" lay-verify="hospitalYear"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea id="hospitalAddress" placeholder="请输入内容" class="layui-textarea" name="hospitalAddress"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="hospitalAbout" placeholder="请输入内容" class="layui-textarea" name="hospitalAbout"></textarea>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea id="hospitalHonor" placeholder="请输入内容" class="layui-textarea" name="hospitalHonor"></textarea>
            </div>
        </div>
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            $.post(
                '${mybasePath}backend/addHospital',
