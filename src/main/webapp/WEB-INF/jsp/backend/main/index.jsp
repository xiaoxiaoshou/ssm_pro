    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${mybasePath}backend/skipUserList">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看全部用户</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${mybasePath}backend/skipHospitalList">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看全部医院</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${mybasePath}backend/skipOfficeList">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看全部科室</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${mybasePath}backend/skipDoctorList">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看全部医生</cite>
                        </a>
                    </li >
