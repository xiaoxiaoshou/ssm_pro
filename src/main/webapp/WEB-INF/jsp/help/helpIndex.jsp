			...
			<div id="myTabContent" class="tab-content">
				...
				<div class="tab-pane fade text-left" id="order">
					...
					<div class="help_right_content">
						...
						用户也可通过（用户022-）电话服务热线进行人工注册、预约，拨打电话注册时需登记真实有效的手机号码或者座机号码。（建议使用手机号码注册预约，以便接收邮件通知和预约、查询使用；若用户想要使用统一平台预约功能则需要在平台上重新验证手机号并设计密码，完成大平台的验证登录流程，才能使用坐席的注册账号在统一平台上预约）<br>
