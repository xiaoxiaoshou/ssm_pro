...
import cn.sfturing.dao.front.FavouriteDao;
import cn.sfturing.entity.CommonUser;
import cn.sfturing.entity.Favourite;
import cn.sfturing.entity.Hospital;
import cn.sfturing.entity.OrderRecords;
import cn.sfturing.service.front.CommonUserService;
import cn.sfturing.service.front.HospitalService;
import cn.sfturing.service.front.OrderRecordsService;
...
public class OrderController {
	...
	public String order(String orderInfoValue, String hospitalName, String officesName, String doctorName,
		...
		if(orderRecords!=null){
			System.out.println(orderRecords.getDoctorName());
		}else{
